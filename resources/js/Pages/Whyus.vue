                                    ...
                                    >
                                        <div class="">
                                              <div class="mb-4">
                                                ...
                                                />
                                                <div
                                                    v-if="$page.errors.pertanyaan"
                                                    class="text-red-500"
                                                >
                                                    {{ $page.errors.pertanyaan[0] }}
                                                </div>
                                            </div>
                                            ...
                                            <div class="mb-4">
                                                ...
                                                ></textarea>
                                                <div
                                                    v-if="$page.errors.jawaban"
                                                    class="text-red-500"
                                                >
                                                    {{ $page.errors.jawaban[0] }}
                                                </div>
                                            </div>
...
export default {
    ...
    methods: {
        ...
        save: function(data) {
            this.$inertia.post("/admin-panel/kenapa-kami/create", data);
        ...
        update: function(data) {
            data._method = "Patch ";
            this.$inertia.post("/admin-panel/kenapa-kami/update", data);
            this.reset();
            this.closeModal();
        },
        deleteRow: function(data) {
            ...
            data._method = "DELETE";
            this.$inertia.post("/admin-panel/kenapa-kami/delete", data);
            this.reset();
            this.closeModal();
        }
    }
